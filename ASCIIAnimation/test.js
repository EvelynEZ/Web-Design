...
(function() {
	...
	var frameID = 0; 
	//the delay between each frames. The default delay time should be 250.
	var speed = 250; 
	...
	function changeSpeed() {
		clearInterval(timer);
		//the set of notes with name "speed".
		var radiogroup = document.getElementsByName("speed"); 
		for (var i = 0; i < radiogroup.length; i++){
			if(radiogroup[i].checked){
				speed = radiogroup[i].value;
			}
		}
		//only continues the animation if it was in action.
