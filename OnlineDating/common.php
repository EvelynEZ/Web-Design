...
#This is a file, containing all the common codes used by the other pages. By calling include, 
#other pages have access to the codes written here.
#Functions:     bottom(). outputs the footer of this website, including an introduction, a copyright
#           statement, a link to the front page and access to the w3c validators.
?>
<!DOCTYPE html>
<html>
	<!--
